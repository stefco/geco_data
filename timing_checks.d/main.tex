...
\centering
\caption{Best-fit piecewise linear curve in the zero crossing region of the second-to-second average of the DuoTone witness signals around the second edge at Hanford EX for the hour surrounding the \graceId\ event candidate. The zero crossing is quite visible at this magnification and is at $\sim 50.7 \mu s$, out of which $52.25 \mu s = 6.7 \mu s$ (DuoTone generation delay) $+ 43.55 \mu s$ (decimation filter delay) of the observed delay is accounted for. This naive zero-crossing approach \textbf{does not} account for DC shift of the signal, which would place the zero-crossing away from zero-phase.}
\centering
\end{figure}
...
\centering
\caption{Best-fit piecewise linear curve in the zero crossing region of the second-to-second average of the DuoTone witness signals around the second edge at Hanford EY for the hour surrounding the \graceId\ event candidate. The zero crossing is quite visible at this magnification and is at $\sim 50.7 \mu s$, out of which $52.25 \mu s = 6.7 \mu s$ (DuoTone generation delay) $+ 43.55 \mu s$ (decimation filter delay) of the observed delay is accounted for. This naive zero-crossing approach \textbf{does not} account for DC shift of the signal, which would place the zero-crossing away from zero-phase.}
\centering
\end{figure}
...
\centering
\caption{Best-fit piecewise linear curve in the zero crossing region of the second-to-second average of the DuoTone witness signals around the second edge at Livingston EX for the hour surrounding the \graceId\ event candidate. The zero crossing is quite visible at this magnification and is at $\sim 50.7 \mu s$, out of which $52.25 \mu s = 6.7 \mu s$ (DuoTone generation delay) $+ 43.55 \mu s$ (decimation filter delay) of the observed delay is accounted for. This naive zero-crossing approach \textbf{does not} account for DC shift of the signal, which would place the zero-crossing away from zero-phase.}
\centering
\end{figure}
...
\centering
\caption{Best-fit piecewise linear curve in the zero crossing region of the second-to-second average of the DuoTone witness signals around the second edge at Livingston EY for the hour surrounding the \graceId\ event candidate. The zero crossing is quite visible at this magnification and is at $\sim 50.7 \mu s$, out of which $52.25 \mu s = 6.7 \mu s$ (DuoTone generation delay) $+ 43.55 \mu s$ (decimation filter delay) of the observed delay is accounted for. This naive zero-crossing approach \textbf{does not} account for DC shift of the signal, which would place the zero-crossing away from zero-phase.}
\centering
\end{figure}
